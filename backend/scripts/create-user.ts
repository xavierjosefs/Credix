...
function parseArgs(argv: string[]): CreateUserArgs {
  ...
  if (!name || !email || !cedula || !password) {
    throw new Error(
      'Debes enviar --name, --email, --cedula y --password. Ejemplo: npm run create:user -- --name "Admin" --email admin@correo.com --cedula 001-1234567-8 --password TuClave123'
    );
  }

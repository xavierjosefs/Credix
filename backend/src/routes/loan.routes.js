...
import { createLoanController, getDisbursementReceiptPdfController, getLoanController, getLoansController, getPaymentReceiptPdfController, registerLoanPaymentController, } from "../controllers/loan.controller.js";
const router = Router();
